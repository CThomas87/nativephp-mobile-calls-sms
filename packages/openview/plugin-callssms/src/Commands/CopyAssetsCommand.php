...
namespace Openview\Callssms\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for Callssms plugin.
 *
...
{
    protected $signature = 'nativephp:callssms:copy-assets';

    protected $description = 'Copy assets for Callssms plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for Callssms');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for Callssms');
    }
}